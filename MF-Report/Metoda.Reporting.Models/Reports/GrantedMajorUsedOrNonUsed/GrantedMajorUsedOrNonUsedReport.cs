...
public class GrantedMajorUsedOrNonUsedPdfReport : PdfReport
{
    public GrantedMajorUsedOrNonUsedPdfReport(
...
public class GrantedMajorUsedOrNonUsedExcelReport : ExcelReport
{
    public GrantedMajorUsedOrNonUsedExcelReport(
