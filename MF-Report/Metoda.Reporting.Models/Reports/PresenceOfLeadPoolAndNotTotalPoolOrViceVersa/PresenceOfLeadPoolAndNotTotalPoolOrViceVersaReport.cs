...
public class PresenceOfLeadPoolAndNotTotalPoolOrViceVersaPdfReport : PdfReport
{
    public PresenceOfLeadPoolAndNotTotalPoolOrViceVersaPdfReport(
...
public class PresenceOfLeadPoolAndNotTotalPoolOrViceVersaExcelReport : ExcelReport
{
    public PresenceOfLeadPoolAndNotTotalPoolOrViceVersaExcelReport(
