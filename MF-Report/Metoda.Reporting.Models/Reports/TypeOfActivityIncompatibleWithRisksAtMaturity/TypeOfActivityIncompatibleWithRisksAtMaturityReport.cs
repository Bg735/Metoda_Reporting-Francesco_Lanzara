...
public class TypeOfActivityIncompatibleWithRisksAtMaturityPdfReport : PdfReport
{
    public TypeOfActivityIncompatibleWithRisksAtMaturityPdfReport(
...
public class TypeOfActivityIncompatibleWithRisksAtMaturityExcelReport : ExcelReport
{
    public TypeOfActivityIncompatibleWithRisksAtMaturityExcelReport(
