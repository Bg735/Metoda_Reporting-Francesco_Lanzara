...
public class InconsistencyBetweenOriginalAndResidualDurationPdfReport : PdfReport
{
    public InconsistencyBetweenOriginalAndResidualDurationPdfReport(
...
public class InconsistencyBetweenOriginalAndResidualDurationExcelReport : ExcelReport
{
    public InconsistencyBetweenOriginalAndResidualDurationExcelReport(
