...
public class OtherCreditsButImpairedPdfReport : PdfReport
{
    public OtherCreditsButImpairedPdfReport(
...
public class OtherCreditsButImpairedExcelReport : ExcelReport
{
    public OtherCreditsButImpairedExcelReport(
