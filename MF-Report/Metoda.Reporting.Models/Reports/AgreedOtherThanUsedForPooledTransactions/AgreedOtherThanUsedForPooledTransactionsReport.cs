...
public class AgreedOtherThanUsedForPooledTransactionsPdfReport : PdfReport
{
    public AgreedOtherThanUsedForPooledTransactionsPdfReport(
...
public class AgreedOtherThanUsedForPooledTransactionsExcelReport : ExcelReport
{
    public AgreedOtherThanUsedForPooledTransactionsExcelReport(
