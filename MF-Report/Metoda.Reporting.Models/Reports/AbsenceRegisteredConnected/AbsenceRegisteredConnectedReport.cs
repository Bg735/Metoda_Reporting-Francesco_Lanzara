...
public class AbsenceRegisteredConnectedPdfReport : PdfReport
{
    public AbsenceRegisteredConnectedPdfReport(
...
public class AbsenceRegisteredConnectedExcelReport : ExcelReport
{
    public AbsenceRegisteredConnectedExcelReport(
