...
public class SummaryOfPerformanceStatementPdfReport : PdfReport
{
    public SummaryOfPerformanceStatementPdfReport(
...
public class SummaryOfPerformanceStatementExcelReport : ExcelReport
{
    public SummaryOfPerformanceStatementExcelReport(
