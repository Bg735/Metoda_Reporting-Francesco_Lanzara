...
public class SufferingsReportedWithOtherPhenomenaPdfReport : PdfReport
{
    public SufferingsReportedWithOtherPhenomenaPdfReport(
...
public class SufferingsReportedWithOtherPhenomenaExcelReport : ExcelReport
{
    public SufferingsReportedWithOtherPhenomenaExcelReport(
